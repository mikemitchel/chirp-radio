...
**Tech Stack:** React 19.1.1 • Capacitor.js v7 • PayloadCMS (separate repo) • Storybook 9.1 • TypeScript • Vitest • Playwright
...
### Research Needed
- CMS webhook for content updates
- Cached API content strategy
- Album art accuracy (API polling with fallback images)
