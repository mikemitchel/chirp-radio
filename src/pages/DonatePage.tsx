...
const DonatePage: React.FC = () => {
  ...
  const { data: pageConfig } = usePageBySlug('donate')
  ...
  return (
    <>
      <Helmet>
        <title>{pageConfig?.title || 'Donate | CHIRP Radio'}</title>
      ...
      <div className="page-layout-main-sidebar">
        <div className="page-layout-main-sidebar__main">
          <CrDonateForm {...donateFormProps} onVinylCircleClick={handleVinylCircleClick} />
        </div>
