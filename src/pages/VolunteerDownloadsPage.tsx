...
const downloadSections = [
  {
    ...
    links: [
      ...
      { text: 'Why You\'re Doing Audio Levels Wrong, and Why It Really Does Matter (Current.org)', url: '#' }
    ]
  },
  {
    id: 'marketing',
  ...
  },
  {
    ...
    links: [
      { text: 'Getting Over the Fear of Asking for Donations (from grassrootsfundraising.org)', url: '#' },
      { text: 'Great DJ Tips', url: '#' },
      { text: 'Interview Questions to Avoid - wisdom from Brendan Kelly of the Lawrence Arms', url: '#' },
      { text: 'Tabling for CHIRP: Everything You Need To Know', url: '#' },
  ...
  },
  {
    ...
    description: 'Here, you\'ll find forms for people who want to donate items to CHIRP, or who would like to make monetary donations offline.',
    links: [
      { text: 'Getting Over the Fear of Asking for Donations (from grassrootsfundraising.org)', url: '#' },
  ...
  },
  {
    ...
    description: 'We\'ll keep an updated list of files you can download and print out to help promote CHIRP events.',
    links: []
  },
  {
    id: 'dj-forms',
  ...
  },
  {
    id: 'logos',
    title: 'Logos',
    description: 'These are various logos for CHIRP Radio and the Chicago Independent Radio Project.',
    links: [
