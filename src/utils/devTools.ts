...
Example usage:
  ...
  simulateAPIStream: () => {
    const mockTracks = [
      {
        ...
        album: 'Abbey Road',
        albumArt: 'https://coverartarchive.org/release/72db542f-9bcc-4fc4-9191-6a487c1d4853/front-500.jpg',
      },
      {
        artist: 'Pink Floyd',
        track: 'Time',
        album: 'The Dark Side of the Moon',
        albumArt: 'https://coverartarchive.org/release/12fb801c-5903-4a99-a10c-7af599fe3986/front-500.jpg',
      },
      {
        artist: 'Radiohead',
        track: 'Karma Police',
        album: 'OK Computer',
        albumArt: 'https://coverartarchive.org/release/a736eb98-ba6b-3e42-ad80-a65f648910a3/front-500.jpg',
      },
      {
        artist: 'Fleetwood Mac',
        track: 'Dreams',
        album: 'Rumours',
        albumArt: 'https://coverartarchive.org/release/7ba2862e-9431-4368-8fc7-9eb3e7fcf42e/front-500.jpg',
      },
      {
        artist: 'David Bowie',
        track: 'Heroes',
        album: 'Heroes',
        albumArt: 'https://coverartarchive.org/release/bdba3f99-52c8-434c-968d-b30b93dbc01e/front-500.jpg',
      },
    ];
    ...
    const cycle = () => {
      ...
      console.log(`🎵 Track ${currentIndex + 1}/${mockTracks.length}:`, track.artist, '-', track.track);
