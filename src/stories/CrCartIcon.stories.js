...
export const Interactive = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive cart icon with click handler. Adds hover effects and keyboard navigation.',
      },
    },
  },
}
...
export const ExtraLargeSize = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Extra large cart icon (60px) with centered badge positioning used in CrShoppingCart.',
      },
    },
  },
}
