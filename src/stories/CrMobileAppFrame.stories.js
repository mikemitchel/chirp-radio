...
export default {
  ...
  argTypes: {
    variant: {
      ...
      description: 'Frame layout variant - landing page with background player or interior page with content and footer player'
    },
    pageTitle: {
      control: 'text',
...
export const Landing = {
  ...
  parameters: {
    docs: {
      description: {
        story: '**Landing page layout** - Mobile header fixed at top with mobile streaming player as full-screen background. Perfect for the main app entry point where the music experience is the primary focus.'
      }
    }
  }
};
...
export const Interior = {
  ...
  parameters: {
    docs: {
      description: {
        story: '**Interior page layout** - Mobile header at top, scrollable content area with default sections, and slim streaming player fixed at bottom like a footer. Ideal for content pages, navigation, and user interactions.'
      }
    }
  }
};
...
export const CustomContent = {
  ...
  render: (args) => React.createElement(CrMobileAppFrame, args, 
    React.createElement('div', { style: { textAlign: 'center', padding: '2rem 0' } },
      React.createElement('h1', { style: { marginBottom: '1rem', color: 'var(--cr-primary-500)' } }, 'My Saved Tracks'),
      React.createElement('p', { style: { marginBottom: '2rem', color: 'var(--cr-default-700)' } }, 'Your personal collection of favorite CHIRP Radio tracks'),
      React.createElement('div', { 
        ...
        React.createElement('div', { 
          ...
          React.createElement('p', { style: { color: 'var(--cr-default-700)', margin: 0 } }, '12 tracks this week')
        ),
        React.createElement('div', { 
          style: { 
          ...
          React.createElement('p', { style: { color: 'var(--cr-default-700)', margin: 0 } }, '87 total plays')
        )
      )
    )
  ),
  parameters: {
    docs: {
      description: {
        story: '**Custom content example** - Interior layout with custom React content passed as children. Shows how to create specific page layouts within the mobile app frame structure.'
      }
    }
  }
};
...
export const WithLiveData = {
  ...
  parameters: {
    docs: {
      description: {
        story: '**Live API data** - Interior layout with streaming player fetching real-time data from CHIRP Radio API. The player will automatically update with current track information.'
      }
    }
  }
};
...
export const InteractiveExample = {
  ...
  render: (args) => {
    ...
    return React.createElement(CrMobileAppFrame, {
      ...args,
      ...
      streamingPlayerProps: {
        ...
        albumArt: 'https://upload.wikimedia.org/wikipedia/en/6/60/The_National_-_Trouble_Will_Find_Me.jpg',
        autoFetch: false,
        isLocal: false
      }
    },
      React.createElement('div', { style: { textAlign: 'center' } },
        React.createElement('p', { style: { marginBottom: '2rem', fontSize: '1.2rem', fontWeight: 'bold' } }, `Current page: ${currentPage}`),
        React.createElement('p', { style: { marginBottom: '2rem', color: 'var(--cr-primary-500)' } }, 'Click the menu button (☰) in the header to open the sidebar navigation!'),
          ...
          ['Discover', 'Schedule', 'Shows', 'Community', 'About'].map(page =>
            React.createElement('button', {
              ...
              style: {
                ...
                background: currentPage === page ? 'var(--cr-primary-500)' : 'var(--cr-default-100)',
        ...
        React.createElement('div', { style: { marginTop: '2rem', padding: '1rem', background: 'var(--cr-default-100)', borderRadius: '8px' } },
          React.createElement('h3', { style: { marginBottom: '1rem' } }, 'Navigation Test'),
          React.createElement('p', { style: { margin: 0 } }, 'Use the sidebar menu to navigate between sections. All navigation handlers are wired up and will update the page title and log to the console.')
        )
      )
    );
  },
  parameters: {
    docs: {
      description: {
        story: '**Interactive sidebar navigation** - Click the menu button (☰) in the header to open the mobile sidebar. All navigation links are functional and will update the page title. Try navigating through different sections to see the sidebar in action!'
      }
    }
  }
};