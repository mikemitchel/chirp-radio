...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'An interactive, animated donation progress bar that shows current amount raised versus target goal. The progress bar animates on first load/visibility.'
      }
    }
  },
  tags: ['autodocs'],
  ...
  render: () => React.createElement('div', {
    ...
    React.createElement('div', { key: 'section1' }, [
      React.createElement('h4', { 
        key: 'title1',
        style: { marginBottom: 'var(--cr-space-3)', color: 'var(--cr-foreground)' }
      }, 'Spring Campaign'),
      React.createElement(CrDonationBar, { 
        key: 'bar1',
        currentAmount: 7271,
