...
export const Default = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default store item component matching the Figma design exactly with product image, details, size/quantity selection, and add to cart button.'
      }
    }
  }
};
...
export const TShirt = {
  args: {
    ...
    price: 25.00,
    description: "High-quality cotton t-shirt featuring the iconic CHIRP Radio logo. Available in standard and fitted styles. Perfect for showing your support for community radio. Comfortable, durable, and stylish - ideal for concerts, events, or everyday wear.",
    image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=600&fit=crop",
    itemType: "Apparel",
...
export const Hoodie = {
  args: {
    ...
    price: 45.00,
    description: "Stay warm while repping your favorite community radio station. This cozy hoodie features the CHIRP Radio logo embroidered on the front with a comfortable cotton-poly blend. Perfect for Chicago winters or chilly concert venues.",
...
export const ToteBag = {
  args: {
    ...
    price: 15.00,
    description: "Eco-friendly cotton tote bag perfect for carrying your vinyl records, groceries, or everyday essentials. Features the CHIRP Radio logo screen-printed in bold colors. Durable construction with reinforced handles.",
...
export const LimitedEditionVinyl = {
  args: {
    ...
    price: 35.00,
    description: "Exclusive vinyl compilation featuring tracks from local Chicago artists who have performed live sessions at CHIRP Radio. Limited press of 500 copies on colored vinyl. Includes digital download code and liner notes with artist interviews.",
...
export const Mobile = {
  args: {
    name: "CHIRP Radio T-Shirt",
    price: 25.00,
    description: "High-quality cotton t-shirt featuring the iconic CHIRP Radio logo. Perfect for showing your support for community radio.",
    image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=600&fit=crop",
    itemType: "Apparel",
    sizeOptions: ["S", "M", "L", "XL"],
    sizeLabel: "T-Shirt Size",
...
export const InteractiveControlled = {
  render: () => {
    ...
    return React.createElement('div', {
      ...
      React.createElement(CrStoreItem, {
        ...
        name: "CHIRP Radio T-Shirt",
        price: 25.00,
        description: "Interactive example with controlled state management. Select size and quantity, then add to cart to see state updates.",
        image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&h=600&fit=crop",
        itemType: "Apparel",
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive store item with controlled state management. Demonstrates size/quantity selection and cart functionality with state updates.'
      }
    }
  }
};