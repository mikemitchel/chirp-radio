...
export default function CrDonateForm({
  ...
  const isFormValid = () => {
    ...
    const hasCustomAmount = selectedAmount === 'other' && customAmount && parseFloat(customAmount) > 0;
    ...
    <div className={componentClasses}>
      ...
      <form className="cr-donate-form__form" onSubmit={handleSubmit}>
        ...
        <div className="cr-donate-form__section">
          <CrDonateAmount
            ...
            amounts={isVinylCircle ? 
              content.amounts.map(item => item.amount) : content.amounts}
      ...
      {showCompanyMatching && !isVinylCircle && (
        <div className="cr-donate-form__company-matching">
          <h2 className="cr-donate-form__section-title">
            Check if your Company Matches
          </h2>
          <p className="cr-donate-form__section-description">
            {companyMatchingDescription}
          </p>
      ...
      {showVinylCircle && !isVinylCircle && (
        <div className="cr-donate-form__vinyl-circle">
          <h2 className="cr-donate-form__section-title-large">
            {vinylCircleTitle}
          </h2>
          <p className="cr-donate-form__section-description">
            {vinylCircleDescription}
          </p>
      ...
      {isVinylCircle && (
        <div className="cr-donate-form__switch-section">
          <h2 className="cr-donate-form__section-title">
            Looking for a smaller donation?
          </h2>
          <p className="cr-donate-form__section-description">
            Not ready for the Vinyl Circle? You can still make a regular donation to support CHIRP Radio.
          </p>
          <div className="cr-donate-form__section-action">
            <CrButton
              variant="text"
