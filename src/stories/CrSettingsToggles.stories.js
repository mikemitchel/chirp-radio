...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Settings toggles component containing Dark Mode, Streaming Quality, and Push Notifications controls. Used in both CrAccountSettingsPage and CrProfileCard.'
      }
    }
  },
  tags: ['autodocs'],
...
export const WithHandlers = {
  render: (args) => React.createElement(CrSettingsToggles, {
    ...args,
