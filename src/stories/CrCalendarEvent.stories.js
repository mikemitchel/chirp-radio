...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'CrCalendarEvent uses calendar display elements, the CrEventItem molecule, and CrButton atom. This component displays monthly calendar views with event management and date navigation functionality. Shows multiple events per day with expandable views and interaction handlers. Supports different calendar layouts and event filtering. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  return [
    {
      ...
      eventDetails:
        'Join fellow volunteers for a community service day. Help us organize the studio and prepare for upcoming events.',
    ...
    },
    {
      ...
      eventDetails:
        'Experience three nights of incredible live performances featuring local and touring artists.',
    ...
    },
    {
      ...
      location: 'CHIRP Studio',
      eventDetails:
        'Learn the basics of DJing from experienced professionals in this hands-on workshop.',
...
export const ManyEvents = {
  args: {
    ...
    events: [
      ...
      },
      {
        ...
        location: 'Main Hall',
        eventDetails:
          'Launch of our annual membership drive with special perks for early supporters.',
      ...
      },
      {
        ...
        eventDetails:
          'Elegant evening of dining, entertainment, and fundraising for independent radio.',
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example with many events showing scrollable event list. Hover over calendar dates to auto-scroll to events.',
      },
    },
  },
}
