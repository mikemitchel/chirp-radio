...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Displays 2-5 images side by side with 24px gap. Each image has 1:1 aspect ratio with min-width 220px and max-width 360px.',
      },
    },
  },
  tags: ['autodocs'],
...
export const TwoImages = {
  ...
  args: {
    images: [
      {
        src: 'https://images.pexels.com/photos/1701595/pexels-photo-1701595.jpeg?auto=compress&cs=tinysrgb&w=400',
        alt: 'Concert crowd',
      },
      {
        src: 'https://images.pexels.com/photos/210922/pexels-photo-210922.jpeg?auto=compress&cs=tinysrgb&w=400',
        alt: 'DJ equipment',
      },
    ],
  },
...
export const FourImages = {
  ...
  args: {
    images: [
      ...
      {
        src: 'https://images.pexels.com/photos/1287142/pexels-photo-1287142.jpeg?auto=compress&cs=tinysrgb&w=400',
        alt: 'Desert sunset',
      },
    ],
  },
