...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrChip atom for on-air status display. Current DJ information component showing DJ name, show title, and on-air status. Handles text truncation for long names. Used in headers and now-playing contexts. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
