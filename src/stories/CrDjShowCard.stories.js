...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrButton atom, text elements, and optional "On-Air" chip indicator. DJ show information card displaying show title, DJ name, and time slot details. Used in schedule grids and show listings. Handles various show states and highlighting. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  argTypes: {
