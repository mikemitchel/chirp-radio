    ...
    <div className="cr-calendar-event">
      <div className="cr-calendar-event__calendar">
        <div className="cr-calendar-event__header">
          ...
          <div className={`cr-calendar-event__month-title ${!canGoPrevious() ? 'cr-calendar-event__month-title--centered' : ''}`}>
            ...
            currentMonthEvents.map((event) => (
              ...
              >
                <CrEventItem
                  ...
                  onMoreInfoClick={event.moreInfoUrl ? () => window.open(event.moreInfoUrl, '_blank') : null}
                />
              </div>
            ))
          ) : (
