...
export default {
  ...
  parameters: {
    ...
    docs: {
  description: {
    component: 'Built from CrButton atom for action button. Page header component with eyebrow text, main title, and optional action button. Used for content sections and page tops. Supports showing/hiding different elements. Dark mode adapts through [data-theme="dark"] CSS selectors.'
  }
}
  },
  argTypes: {
