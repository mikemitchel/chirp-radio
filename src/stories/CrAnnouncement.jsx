...
export default function CrAnnouncement({
  ...
  button2Icon = 'mobile',
  button2OnClick,
  // Donation bar props (only used when variant is 'donation')
  currentAmount = 7271,
  targetAmount = 48000,
  onDonateClick,
  className = ""
  ...
  return (
    <div className={componentClasses}>
      <div className="cr-announcement__content">
        ...
        {/* Headline */}
        <h2 className="cr-announcement__headline">
          {headlineText}
        </h2>

        {/* Body Text */}
        <p className="cr-announcement__body">
          {bodyText}
        </p>
