    ...
    React.createElement('div', { className: 'sg-section' }, [
      ...
      React.createElement('div', { key: 'intro', className: 'sg-card sg-margin-bottom-lg' }, [
        ...
        React.createElement('div', { key: 'intro-content', className: 'sg-card-content' }, [
          React.createElement('p', { key: 'intro-text', className: 'cr-body-reg sg-margin-bottom' }, 
          ...
          React.createElement('div', { key: 'numeric', className: 'sg-example-card' }, [
            ...
            React.createElement('div', { key: 'numeric-grid', className: 'sg-spacing-grid' }, [
              React.createElement('div', { key: 'space-1', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-1'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-xs' }),
              ...
              React.createElement('div', { key: 'space-2', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-2'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-sm' }),
              ...
              React.createElement('div', { key: 'space-3', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-3'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-3' }),
              ...
              React.createElement('div', { key: 'space-4', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-4'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-md' }),
              ...
              React.createElement('div', { key: 'space-6', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-6'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-lg' }),
              ...
              React.createElement('div', { key: 'space-8', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-8'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-xl' }),
              ...
              React.createElement('div', { key: 'space-12', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-12'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-2xl' }),
              ...
              React.createElement('div', { key: 'space-16', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label' }, 'cr-space-16'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar sg-spacing-bar-3xl' }),
          ...
          React.createElement('div', { key: 'semantic', className: 'sg-example-card' }, [
            ...
            React.createElement('div', { key: 'semantic-grid', className: 'sg-spacing-grid' }, [
              React.createElement('div', { key: 'space-xs', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-xs'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-xs' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '4px - Tight spacing')
              ]),
              React.createElement('div', { key: 'space-sm', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-sm'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-sm' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '8px - Small spacing')
              ]),
              React.createElement('div', { key: 'space-md', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-md'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-md' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '16px - Medium spacing')
              ]),
              React.createElement('div', { key: 'space-lg', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-lg'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-lg' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '24px - Large spacing')
              ]),
              React.createElement('div', { key: 'space-xl', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-xl'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-xl' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '32px - Extra large')
              ]),
              React.createElement('div', { key: 'space-2xl', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-2xl'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-2xl' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '48px - 2X large')
              ]),
              React.createElement('div', { key: 'space-3xl', className: 'sg-spacing-row' }, [
                React.createElement('span', { key: 'label', className: 'sg-spacing-label-wide' }, 'cr-space-3xl'),
                React.createElement('div', { key: 'bar', className: 'sg-spacing-bar-secondary sg-spacing-bar-3xl' }),
                React.createElement('span', { key: 'value', className: 'sg-spacing-value' }, '64px - 3X large')
              ])
            ])
          ])
        ])
      ...
      React.createElement('div', { key: 'spacing-applications', className: 'sg-spacing-section' }, [
        ...
        React.createElement('div', { key: 'applications-grid', className: 'sg-component-grid' }, [
          ...
          React.createElement('div', { key: 'padding', className: 'sg-example-card' }, [
            ...
            React.createElement('div', { key: 'padding-examples', className: 'sg-spacing-examples' }, [
              React.createElement('div', { key: 'small-gap', className: 'sg-spacing-example' }, [
                React.createElement('div', { key: 'eyebrow', className: 'sg-eyebrow' }, 'Small Gap (8px)'),
                React.createElement('div', { key: 'demo', className: 'sg-flex-row sg-gap-sm sg-padding-sm sg-bg-secondary-light' }, [
                  React.createElement('div', { key: 'item1', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 1'),
                  React.createElement('div', { key: 'item2', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 2'),
                  React.createElement('div', { key: 'item3', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 3')
                ])
              ]),

              React.createElement('div', { key: 'medium-gap', className: 'sg-spacing-example' }, [
                React.createElement('div', { key: 'eyebrow', className: 'sg-eyebrow' }, 'Medium Gap (16px)'),
                React.createElement('div', { key: 'demo', className: 'sg-flex-row sg-gap-md sg-padding-sm sg-bg-secondary-light' }, [
                  React.createElement('div', { key: 'item1', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 1'),
                  React.createElement('div', { key: 'item2', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 2'),
                  React.createElement('div', { key: 'item3', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 3')
                ])
              ...
              React.createElement('div', { key: 'large-gap', className: 'sg-spacing-example' }, [
                React.createElement('div', { key: 'eyebrow', className: 'sg-eyebrow' }, 'Large Gap (24px)'),
                React.createElement('div', { key: 'demo', className: 'sg-flex-row sg-gap-lg sg-padding-sm sg-bg-secondary-light' }, [
                  React.createElement('div', { key: 'item1', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 1'),
                  React.createElement('div', { key: 'item2', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 2'),
                  React.createElement('div', { key: 'item3', className: 'sg-spacing-demo-box sg-flex-item' }, 'Item 3')
                ])
        ...
        React.createElement('div', { key: 'guidelines-content', className: 'sg-card-content' }, [
          React.createElement('div', { key: 'guidelines-grid', className: 'sg-component-grid' }, [
            React.createElement('div', { key: 'guidelines-left' }, [
              React.createElement('div', { key: 'component-padding', className: 'cr-body-reg sg-margin-bottom' }, [
                React.createElement('strong', { key: 'strong1' }, 'Component Padding:'),
                ' Use --cr-space-md (16px) for standard component internal spacing'
              ]),

              React.createElement('div', { key: 'element-margins', className: 'cr-body-reg sg-margin-bottom' }, [
            ...
            React.createElement('div', { key: 'guidelines-right' }, [
              React.createElement('div', { key: 'button-groups', className: 'cr-body-reg sg-margin-bottom' }, [
                React.createElement('strong', { key: 'strong4' }, 'Button Groups:'),
                ' Use --cr-space-3 (12px) gap between related buttons'
              ]),

              React.createElement('div', { key: 'form-fields', className: 'cr-body-reg sg-margin-bottom' }, [
