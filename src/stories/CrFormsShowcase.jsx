    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <p style={{ 
          ...
          Complete documentation of form elements, input styles, and layout patterns used across CHIRP Radio components.
        </p>
      </div>
          ...
          <div style={{ 
            ...
            <div className="form-group">
              ...
              <div className="form-checkbox-grid">
                {['Marketing', 'Photography', 'Journalism', 'Sales', 'Politics', 'Fundraising'].map(skill => (
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div style={{ 
                ...
                <div className="form-group">
                  ...
                  <textarea
                    placeholder="Tell us about the song you'd like to hear..."
                    rows={4}
                  />
                </div>
              </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ fontFamily: 'monospace', fontSize: '14px', lineHeight: '1.6' }}>
              <div><strong>.form-section</strong> - Form section container</div>
              <div><strong>.form-group</strong> - Individual form field group</div>
              <div><strong>.form-row</strong> - Horizontal row layout</div>
              <div><strong>.form-label</strong> - Form field labels</div>
              <div><strong>.form-actions</strong> - Form action buttons</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ fontFamily: 'monospace', fontSize: '14px', lineHeight: '1.6' }}>
              <div><strong>.form-checkbox-grid</strong> - Checkbox grid layout</div>
              <div><strong>.form-checkbox-item</strong> - Individual checkbox</div>
              <div><strong>.form-radio-group</strong> - Radio button group</div>
              <div><strong>.form-radio-item</strong> - Individual radio button</div>
              <div><strong>.form-social-inputs</strong> - Social media inputs</div>
              <div><strong>.form-social-input-item</strong> - Social input with icon</div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ fontFamily: 'monospace', fontSize: '14px', lineHeight: '1.6' }}>
              <div><strong>input[type="text"]</strong> - Global text input</div>
              <div><strong>input[type="email"]</strong> - Global email input</div>
              <div><strong>input[type="tel"]</strong> - Global phone input</div>
              <div><strong>select</strong> - Global select dropdown</div>
              <div><strong>textarea</strong> - Global textarea</div>
              <div><strong>.form-input--social</strong> - Social media input</div>
            </div>
          </div>
        </div>
      </div>
