...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from text header elements. Table header component for playlist views with column labels for artwork, track info, time played, and actions. Provides consistent labeling for tabular playlist displays. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
