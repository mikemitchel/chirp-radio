...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrButton atoms for ticket and share actions. Card header component with preheader text, main title, and action buttons. Supports different heights (narrow/tall) and text layouts (stacked/inline). Includes optional textured backgrounds. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  argTypes: {
    ...
    textLayout: {
      ...
      description:
        'Text layout - stacked (vertical) or inline (horizontal). Note: narrow height forces inline.',
    },
    height: {
      control: 'select',
      options: ['narrow', 'tall'],
      description:
        'Component height - narrow (60px) or tall (84px). Narrow forces inline text layout.',
    },
    backgroundColor: {
      control: 'select',
...
export const ThreeVariations = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Three variations: Tall Stacked, Tall Inline, and Narrow (which forces inline layout).',
      },
    },
  },
}
