...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrChip atom for category tag. Product display card showing item image, name, price, and category tag. Used in store listings and product grids. Supports click interactions and hover states. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Default store item card matching the Figma design exactly with product image, name, price, and type chip.',
      },
    },
  },
}
...
export const GridLayout = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example showing multiple store item cards in a responsive grid layout, demonstrating how they would appear in a real shop listing.',
      },
    },
  },
}
...
export const InteractiveClickable = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive store item card with click handler. Shows hover effects and click functionality that would navigate to item detail page.',
      },
    },
  },
}
...
export const Mobile = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Store item card optimized for mobile viewport with smaller image and responsive text handling.',
      },
    },
  },
}
