...
export default function CrCard({
  ...
  // Image aspect ratio
  imageAspectRatio = "4:3", // "4:3" or "16:9"
  ...
  const componentClasses = React.useMemo(() => [
    ...
    `cr-card--${imageAspectRatio.replace(':', '-')}`,
    className
  ].filter(Boolean).join(' '), [variant, imagePosition, imageSize, imageAspectRatio, className]);
  ...
  ), [preheader, title, bannerButtonText, shareButtonText, onBannerTicketClick, onBannerShareClick]);
        ...
        return (
          <div className={componentClasses}>
            ...
            <div className="cr-card__small-main">
              <div className={`cr-card__small-image cr-card__small-image--${imageAspectRatio.replace(':', '-')}`}>
                <div 
                  className="cr-card__image"
                  style={{ backgroundImage: `url(${backgroundImage})` }}
                />
      ...
      case "narrow":
        return (
          <div className={componentClasses}>
            ...
            <div className={`cr-card__narrow-image cr-card__narrow-image--${imageAspectRatio.replace(':', '-')}`}>
              <div 
                className="cr-card__image"
                style={{ backgroundImage: `url(${backgroundImage})` }}
              />
          ...
          <div className={componentClasses}>
            ...
            <div className="cr-card__main-section">
              <div className="cr-card__wide-image-wrapper">
                <div 
                  className={`cr-card__wide-image cr-card__wide-image--${imageAspectRatio.replace(':', '-')}`}
                  style={{ backgroundImage: `url(${backgroundImage})` }}
                />
              </div>
