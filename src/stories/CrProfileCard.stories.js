...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'CrProfileCard uses the CrPageHeader molecule, the CrChip atom, the CrButton atom, the CrSocialIcon atom, the CrTable organism, the CrProfileEditForm template, and the CrVolunteerEditForm template. This component provides complete user profile management with view, edit profile, and edit volunteer states. This extensive composition of atoms, molecules, organisms, and other templates makes it a proper Template. Includes avatar management, social links, permissions display, and custom saved tracks table functionality. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  argTypes: {
  ...
  render: (args) => {
    ...
    const [profileState, setProfileState] = React.useState({
      ...
      formData: {
        ...
        email: args.email,
        djBio:
          "Sarah brings energy and passion to Chicago's underground music scene, specializing in electronic, house, and techno. With over 5 years of DJing experience, she's known for seamless mixing and discovering new artists.",
        primaryPhoneType: 'mobile',
