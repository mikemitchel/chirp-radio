...
export default function CrTable({
  ...
  const getSortIcon = (columnKey) => {
    ...
    if (sortColumn === columnKey) {
      return sortDirection === 'asc' ? 
        React.createElement(PiCaretUp, { className: 'cr-table__sort-icon cr-table__sort-icon--active' }) :
        React.createElement(PiCaretDown, { className: 'cr-table__sort-icon cr-table__sort-icon--active' });
    }
    
    return React.createElement(PiCaretUpDown, { className: 'cr-table__sort-icon' });
  };
  ...
  const shouldShowActionButton = showActionButton && (actionButtonIcon || actionButtonText !== "Action" || onActionClick);
    ...
    return (
      <div className="cr-table__mobile-cards">
        {sortedData.map((row, rowIndex) => (
          <div 
            key={row.id || rowIndex}
            className="cr-table__mobile-card"
          >
            {columns.map((column) => {
              ...
              return (
                <div key={column.key} className="cr-table__mobile-row">
                  <div className="cr-table__mobile-label">
                    {column.title || column.key}
                  </div>
                  <div className="cr-table__mobile-value">
                    {cellContent}
                  </div>
                </div>
              );
    ...
    <div className="cr-table-wrapper">
      ...
      <div className={componentClasses}>
        <div className="cr-table__wrapper">
          ...
          >
            {caption && (
              <caption className="cr-table__caption">
                {caption}
              </caption>
            )}
                ...
                {columns.map((column) => (
                  ...
                  >
                    <div className="cr-table__header-content">
                      <span className="cr-table__header-text">
                        {column.title || column.key}
                      </span>
            ...
            <tbody className={bodyClasses}>
              {loading ? (
                ...
                <tr className="cr-table__empty-row">
                  <td 
                    className="cr-table__empty-cell" 
                    colSpan={columns.length}
                    role="status"
                  >
                    <div className="cr-table__empty-content">
      ...
      <div className="cr-table__mobile-container">
        {renderMobileCards()}
      </div>
    </div>
  );
