...
export const Default = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Default image cropper with drag-and-drop upload. Click or drag an image file to upload, then use the crop modal to create both full and avatar versions. Properly handles both landscape and portrait images.',
      },
    },
  },
}
...
export const InteractiveDemo = {
  render: (args) => {
    ...
    const infoSection = React.createElement(
      'div',
      {
        style: {
          marginBottom: '24px',
    ...
    const resultSection = imageState.croppedImage
      ? React.createElement(
          'div',
          {
            style: {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Full interactive demo showing the complete workflow: upload, crop, zoom, and see the final results. Try uploading your own image to test the cropping functionality.',
      },
    },
  },
}
