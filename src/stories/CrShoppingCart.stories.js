...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from theCrButton atom and CrCartIcon atom. E-commerce shopping cart component with item management, quantity controls, and checkout functionality. Supports add/remove items and total calculations. Used in store interfaces. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Default shopping cart component matching the Figma design with 5 items, each priced at $00.00 placeholder values. Shows the cart icon with badge count and proper typography hierarchy.',
      },
    },
  },
}
...
export const MerchandiseCart = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shopping cart with realistic CHIRP Radio merchandise including varied quantities, sizes, and colors.',
      },
    },
  },
}
...
export const MinimalItems = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shopping cart with minimal item data (name and price only) to test the component with basic required props.',
      },
    },
  },
}
...
export const LargeQuantities = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shopping cart with items having large quantities to test badge display with high numbers (44 total items).',
      },
    },
  },
}
...
export const Mobile = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Shopping cart optimized for mobile viewport with stacked action buttons and responsive spacing.',
      },
    },
  },
}
...
export const DarkMode = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Shopping cart in dark mode using CSS variables. Colors automatically adapt through the design system.',
      },
    },
  },
}
...
export const Interactive = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive shopping cart with ability to add random items and trigger cart actions. Demonstrates real-time updates to item count badge and total calculations.',
      },
    },
  },
}
