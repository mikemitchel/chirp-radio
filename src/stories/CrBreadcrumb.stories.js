...
docs: {
  description: {
    component: 'Built from CrLogo atom and navigation link elements. Navigation path component showing user location hierarchy with clickable ancestor links. Includes optional CHIRP logo and separator arrows between path segments. Handles responsive truncation for long paths. Dark mode adapts through [data-theme="dark"] CSS selectors.'
  }
}
  },
  tags: ['autodocs'],
