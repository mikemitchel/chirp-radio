...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A social media icon component with platform-specific branding colors and consistent styling. Supports links, buttons, and static display modes. Is expandable as needed.',
      },
    },
  },
  argTypes: {
