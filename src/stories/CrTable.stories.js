...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrPageHeader molecule and CrButton atom and table cell elements. Data table component with sorting, loading states, and pagination. This uses page header molecule - consider moving to Organisms category. Supports different size variants and responsive behavior. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  argTypes: {
        ...
        [
          React.createElement(
            'button',
            {
              ...
              onMouseOver: (e) => {
                e.target.style.color = 'var(--cr-primary-500)'
              },
              onMouseOut: (e) => {
                e.target.style.color = 'var(--cr-default-500)'
              },
...
export const DonationHistory = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Donation history table - the default use case showing Date, Type, Amount, and Receipt columns. Sorted by date (most recent first). Features CrPageHeader with eyebrow text and export action button. Receipt buttons use CrButton component with download icon.',
      },
    },
  },
}
...
export const Sortable = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Table with sortable columns. Click on column headers to sort. Sorting works automatically for strings, numbers, and handles null values properly.',
      },
    },
  },
}
...
export const Compact = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Compact variant with reduced padding, useful for displaying more data in less space.',
      },
    },
  },
}
...
export const Complex = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complex table demonstrating custom renderers, status badges, ratings, formatted numbers, and full page header integration.',
      },
    },
  },
}
