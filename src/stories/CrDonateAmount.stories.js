...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Built from CrButton atoms in a button group pattern. Donation amount selector with preset amounts and custom input option. Functions as a tabbed button group for selecting contribution levels. Used in donation forms and funding campaigns. Dark mode adapts through [data-theme="dark"] CSS selectors.',
      },
    },
  },
  tags: ['autodocs'],
