...
const Template = (args) => {
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('p', { key: 'desc' }, 'This demonstrates how the sidebar slides out as a lightbox overlay without pushing content.'),
      React.createElement('p', { key: 'desc2' }, 'The sidebar should appear over this content with a backdrop.'),
      React.createElement('div', { 
        key: 'filler',
        style: { height: '200vh', background: 'linear-gradient(to bottom, #f0f0f0, #e0e0e0)' }
...
MobileInteractive.parameters = {
  ...
  docs: {
    description: {
      story: 'Mobile sidebar with all interaction handlers configured. Shows the mobile-specific sections like "Now Playing", "Recent Playlist", and "Your Collection" at the top, plus the close button.'
    }
  }
};
