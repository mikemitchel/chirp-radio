...
docs: {
  description: {
    component: 'Built from CrButton atoms, CrSocialIcon atoms, and CrImageCropper molecule. Complex profile editing form with personal info, avatar upload, and social links. This uses image cropper molecule - consider moving to Organisms category. Handles validation and form state management. Dark mode adapts through [data-theme="dark"] CSS selectors.'
  }
}
  },
  argTypes: {
...
export const Default = {
  args: {
    ...
    originalFullImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face"
  },
  render: (args) => {
...
export const DJProfile = {
  args: {
    ...
    originalFullImage: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop&crop=face"
  },
  render: (args) => {
    const [formData, setFormData] = React.useState(args.formData);
