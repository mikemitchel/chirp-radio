  ...
  render: (args) => {
    return React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('p', { key: 'main-desc' }, 'This content is behind the scrim overlay.'),
        React.createElement('p', { key: 'main-desc2' }, 'Adjust the controls to see how the scrim behaves.')
      ]),
      React.createElement(CrScrim, { 
        key: 'main-scrim',
        ...args 
      }, 
        React.createElement('div', {
          ...
          React.createElement('p', { key: 'overlay-desc' }, 'This content appears over the scrim.')
        ])
      )
    ]);
  }
  ...
  render: () => {
    ...
    return React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('p', { key: 'interactive-desc' }, 'Click the button to show/hide the scrim overlay.'),
      ...
      React.createElement(CrScrim, {
        ...
        React.createElement('div', {
          ...
          React.createElement('h2', { key: 'interactive-overlay-title' }, 'Click Outside to Close'),
          React.createElement('p', { key: 'interactive-overlay-desc' }, 'This demonstrates click-to-close behavior.'),
          React.createElement(CrButton, {
...
export const WithModal = {
  render: () => {
    ...
    return React.createElement('div', {
      ...
      React.createElement('p', { key: 'modal-demo-desc' }, 'This shows how CrScrim works with CrModal.'),
      React.createElement(CrButton, {
        key: 'modal-open-btn',
        variant: 'solid',
        color: 'primary',
      ...
      React.createElement(CrModal, {
        ...
        React.createElement('p', { key: 'modal-content-p1' }, 'This modal uses CrScrim internally for its backdrop.'),
        React.createElement('p', { key: 'modal-content-p2' }, 'Notice how the scrim opacity and behavior work together.')
      ])
    ]);
  }
};