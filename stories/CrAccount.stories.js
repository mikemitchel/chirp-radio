...
docs: {
  description: {
    component: 'Built from CrAvatar and CrButton atoms with CrChip atoms for tags. User account display component showing login state, user info, and volunteer status. Displays CHIRP bird logo when logged out or user avatar when logged in. Includes volunteer dropdown and category tags for DJ specialties. Dark mode adapts through [data-theme="dark"] CSS selectors.'
  }
}
  },
  tags: ['autodocs'],
